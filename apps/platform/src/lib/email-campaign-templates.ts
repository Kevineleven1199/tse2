...
export const CAMPAIGN_TEMPLATES: CampaignTemplate[] = [
  {
    ...
    subject: "Healthier workspace for {{businessName}} — organic cleaning",
...
<div class="container">
  <div class="header">
    ...
    <p style="margin:8px 0 0;opacity:0.9;">100% Organic Commercial Cleaning</p>
  </div>
  <div class="content">
    <p>Hi {{ownerName}},</p>
    ...
    <div class="highlight">
      ...
      <ul>
        <li>100% organic, non-toxic cleaning products (EPA Safer Choice certified)</li>
    ...
    <a href="https://tseorganic.com/request" class="cta">Schedule Free Estimate →</a>

    <p>Best regards,<br><strong>Kevin Flanagan</strong><br>Tri State Enterprise<br>(941) 335-7955</p>
  </div>
  <div class="footer">
    <p>Tri State Enterprise | Flatwoods, KY | <a href="https://tseorganic.com">tseorganic.com</a></p>
...
<div class="container">
  <div class="header">
    <h1>Tri State Enterprise</h1>
    <p style="margin:8px 0 0;opacity:0.9;">Healthcare-Grade Organic Cleaning</p>
  </div>
  <div class="content">
    <p>Hi {{ownerName}},</p>
    ...
    <div class="highlight">
      ...
      <ul>
        <li><strong>EPA-registered disinfectants</strong> that are non-toxic and fragrance-free</li>
    ...
    <a href="https://tseorganic.com/request" class="cta">Get a Free Healthcare Facility Quote →</a>
...
<div class="container">
  ...
  <div class="content">
    <p>Hi {{ownerName}},</p>
    <p>I'm reaching out to {{businessName}} because we specialize in keeping condo and HOA common areas spotless using 100% organic, resident-safe products.</p>
    ...
    <p>Residents notice the difference when we clean — the fresh, chemical-free smell alone generates positive feedback at board meetings.</p>
    
    <p>Can I send over a custom proposal for {{businessName}}'s common areas? I just need a quick 10-minute walkthrough.</p>

    <a href="https://tseorganic.com/request" class="cta">Request a Free Walkthrough →</a>
  ...
  },
  {
    ...
    description: "For daycares and childcare centers. Parents demand non-toxic environments.",
    htmlContent: `<!DOCTYPE html><html><head>${baseStyle}</head><body>
<div class="container">
  <div class="header">
    <h1>Tri State Enterprise</h1>
    <p style="margin:8px 0 0;opacity:0.9;">Child-Safe Organic Cleaning</p>
  </div>
  <div class="content">
    <p>Hi {{ownerName}},</p>
    ...
    <p>Imagine telling parents: <em>"We only use 100% organic, EPA Safer Choice certified cleaning products."</em> That's a powerful differentiator for {{businessName}}.</p>

    <a href="https://tseorganic.com/request" class="cta">Get a Free Daycare Cleaning Quote →</a>
  ...
  },
  {
    ...
    subject: "Quick follow-up — organic cleaning for {{businessName}}",
    category: "follow_up",
    targetIndustries: [],
...
<div class="container">
  <div class="content" style="border-radius:12px;border:1px solid #e5e7eb;">
    <p>Hi {{ownerName}},</p>
    <p>I sent a note a few days ago about organic cleaning for {{businessName}} and wanted to make sure it didn't get buried in your inbox.</p>
  ...
  },
  {
    ...
    subject: "3 reasons {{city}} businesses are switching to organic cleaning",
    category: "follow_up",
    targetIndustries: [],
...
<div class="container">
  <div class="content" style="border-radius:12px;border:1px solid #e5e7eb;">
    <p>Hi {{ownerName}},</p>
    <p>I wanted to share why more {{city}} businesses are making the switch to organic cleaning:</p>
    ...
    <p><strong>3. It's a marketing advantage</strong><br>"We use 100% organic cleaning products" is something your customers and employees notice and appreciate.</p>
