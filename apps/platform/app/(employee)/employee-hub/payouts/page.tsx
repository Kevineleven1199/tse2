...
const EmployeePayoutsPage = () => {
  ...
  const handleSubmitCleanerId = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!cleanerId) {
      setError("Enter a cleaner ID to view payouts.");
      return;
    }
      ...
      <Card className="bg-white">
        <CardHeader className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            Track your deposits, see what&apos;s pending, and download statements for bookkeeping.
          </p>
        </CardHeader>
        <CardContent className="space-y-5">
          ...
          <Link
            ...
            className="block rounded-2xl border border-brand-100 bg-brand-50/40 p-4 text-sm text-accent transition hover:bg-brand-100/40"
          >
            <p className="font-semibold">View Full Payroll Breakdown →</p>
            <p className="mt-1 text-xs text-muted-foreground">
              See your hours, hourly rate, deductions, reimbursements, and net pay.
            </p>
          </Link>
          ...
          <div className="rounded-2xl border border-brand-100 bg-brand-50/40 p-4 text-xs text-muted-foreground">
            ...
            <p>
              Connect your PayPal email in the Tri State app to receive instant payouts. Otherwise deposits default to Stripe Connect and may
      ...
      <Card className="bg-white">
        ...
        <CardContent className="space-y-4">
          {payouts?.history?.length ? (
            ...
            <div className="rounded-2xl border border-brand-100 bg-white px-4 py-12 text-center text-sm text-muted-foreground">
              No payouts yet — grab jobs from Open Jobs and complete your first clean to see deposits here.
            </div>
          )}
        </CardContent>
      </Card>
...
export default EmployeePayoutsPage;
