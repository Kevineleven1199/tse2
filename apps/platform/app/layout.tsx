...
export const metadata: Metadata = {
  ...
  keywords: [
    "construction company Flatwoods KY",
    "HVAC contractor Ashland Kentucky",
    "landscaping Flatwoods KY",
    "lawn care service Ashland KY",
    "site work contractor Greenup County",
    "paving company Tri-State area",
    "Tri State Enterprise",
    "heating and air conditioning Flatwoods",
    "general contractor Boyd County KY",
    "commercial construction Kentucky Ohio West Virginia",
    "furnace repair Flatwoods KY",
    "air conditioning installation Ashland",
    "driveway paving Greenup County",
    "excavation contractor eastern Kentucky",
    "landscape design Russell KY",
    "lawn mowing service Flatwoods Ashland",
    "residential construction Tri-State",
    "HVAC installation near me",
    "best contractor Flatwoods KY",
    "licensed insured contractor Kentucky",
    "home renovation Ashland KY",
    "grading and excavation Boyd County",
    "retaining wall contractor Kentucky",
    "parking lot paving eastern KY",
    "emergency HVAC repair Tri-State area",
  ],
...
const jsonLd = {
  ...
  "@type": ["GeneralContractor", "HVACBusiness", "LandscapingBusiness", "LocalBusiness"],
  "@id": "https://tsenow.com",
  name: "Tri State Enterprise",
  alternateName: "TSE",
  description:
    "Serving the Kentucky-Ohio-West Virginia Tri-State area since 1992, Tri State Enterprise delivers trusted services in Construction, HVAC, Lawn Care, Landscaping, Site Work, and Paving. Licensed, bonded, and insured. One Call Does It All.",
  url: "https://tsenow.com",
  telephone: "+16068362534",
  email: "tse@tristateenterprise.com",
  image: "https://tsenow.com/images/og-cover.jpg",
  logo: "https://tsenow.com/images/tse-logo.png",
  priceRange: "$$",
  ...
  knowsAbout: [
    "Residential Construction", "Commercial Construction", "Home Renovation",
    "HVAC Installation", "Furnace Repair", "Air Conditioning", "Heat Pump",
    "Lawn Care", "Landscape Design", "Retaining Walls", "Hardscaping",
    "Site Grading", "Excavation", "Driveway Paving", "Parking Lot Paving",
    "Drainage Solutions", "French Drains", "Concrete Work"
  ],
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Tri State Enterprise Services",
    itemListElement: [
      { "@type": "OfferCatalog", name: "Construction", description: "New builds, renovations, additions, remodeling, structural repairs" },
      { "@type": "OfferCatalog", name: "HVAC", description: "Heating & air conditioning installation, repair, and maintenance" },
      { "@type": "OfferCatalog", name: "Lawn Care", description: "Mowing, edging, trimming, fertilization, weed control" },
      { "@type": "OfferCatalog", name: "Landscaping", description: "Landscape design, planting, mulching, retaining walls, hardscaping" },
      { "@type": "OfferCatalog", name: "Site Work", description: "Grading, excavation, land clearing, drainage, utility trenching" },
      { "@type": "OfferCatalog", name: "Paving", description: "Driveway paving, parking lots, sidewalks, seal coating" },
    ],
  },
  address: {
    "@type": "PostalAddress",
  ...
  areaServed: [
    ...
    { "@type": "City", name: "Flatwoods, KY" },
    { "@type": "City", name: "Ashland, KY" },
    { "@type": "City", name: "Russell, KY" },
    { "@type": "City", name: "Catlettsburg, KY" },
    { "@type": "City", name: "South Shore, KY" },
    { "@type": "City", name: "Grayson, KY" },
    { "@type": "City", name: "Huntington, WV" },
    { "@type": "City", name: "Ironton, OH" },
