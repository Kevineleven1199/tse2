...
const DRIP_TEMPLATES = {
  ...
  "post-service": [
    ...
    },
    {
      ...
      delay: 3,
      html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px"><h2 style="color:#2E7D32">Love Your Clean? Share the Love! 🎁</h2><p>For every friend you refer who books a clean, you <strong>both get $25 off</strong>!</p><p>Just share your unique referral link (find it in your <a href="https://tsenow.com/client" style="color:#2E7D32">client portal</a>) or call us at (606) 836-2534.</p><p style="color:#6b7280;font-size:13px">There's no limit — refer 10 friends, earn $250 in credits!</p></div>`,
    },
  ],
